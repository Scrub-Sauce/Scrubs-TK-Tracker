...
def run_bot():
    ...
    async def tk(req_obj: discord.Interaction, killer: discord.Member, victim: discord.Member):
        tk_messages = [
            [
        ...
        status_add_kill, tk_object = add_teamkill(killer, victim, req_obj.guild)
